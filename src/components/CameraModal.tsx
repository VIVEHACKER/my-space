		...
		<div className="fixed inset-0 z-50" onClick={onClose}>
			...
			<div className="absolute inset-0 pointer-events-none overflow-hidden">
				<div
					...
					style={{ top: "10%", left: "5%", width: 80, height: 80 }}
				/>
				<div
					className="aero-bubble"
					style={{ top: "60%", right: "8%", width: 60, height: 60 }}
				/>
				<div
					className="aero-bubble"
			...
			>
				<div className="aero-xp-window">
					...
					<div className="aero-xp-titlebar">
						...
						<span className="aero-xp-titlebar-text">
							Camera Zone - Photo Album
						</span>
						<div className="aero-xp-titlebar-buttons">
							...
							<button className="aero-xp-btn-close" onClick={onClose}>
								✕
							</button>
						</div>
					</div>
					...
					<div className="aero-xp-content">
						...
						<div className="aero-xp-nav">
							<button onClick={flipPrev} className="aero-nav-pill">
								◀ Prev
							</button>
							<button onClick={flipNext} className="aero-nav-pill">
								Next ▶
							</button>
						</div>
